...
;; The default is800 kilobytes.  Measured in bytes.
...
(use-package general
  ...
  (efs/leader-keys
    ...
    "fc" '(lambda () (interactive) (find-file (expand-file-name "C:\\Users\\rcrawford\\AppData\\Roaming\\.emacs.el")))

    "fw" '(lambda () (interactive) (find-file (expand-file-name "H:\\work.org"))))
...
'(org-agenda-files '("h:/passnotes.org" "h:/todo.org" "h:/work.org"))

'(package-selected-packages

   '(org-bullets all-the-icons doom-themes evil-collection evil general which-key auto-package-update)))
